...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UBombermanGameViewportClient()
	{
		...
		if (!OuterClass)
		{
			...
			OuterClass = UBombermanGameViewportClient::StaticClass();
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<UBombermanGameViewportClient> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				MetaData->SetValue(OuterClass, TEXT("IncludePath"), TEXT("BombermanGameViewportClient.h"));
				MetaData->SetValue(OuterClass, TEXT("ModuleRelativePath"), TEXT("BombermanGameViewportClient.h"));
#endif
			}
		}
	...
	IMPLEMENT_CLASS(UBombermanGameViewportClient, 643878871);
